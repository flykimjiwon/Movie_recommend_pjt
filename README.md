# 최종_PJT - 알고리즘을 이용한 사용자 기반 영화 추천 사이트
...
| 11/25 | PPT마무리,readme마무리,최적화                                | PPT 뼈대및 전체완성,readme마무리                             | 오류수정                                 |
...
![image-20211125165749094](README.assets/image-20211125165749094.png)

* 첫화면을 로그인 화면으로 만들었습니다. 이 사이트는 로그인 해야만 이용 할 수 있습니다!

  기본적인 장고 내장 form을 이용했지만 간단하게 버튼과 박스만 디자인 했습니다.

![image-20211125165759350](README.assets/image-20211125165759350.png)

* 회원가입 페이지 입니다.

  이 역시 기본적인 내장폼을 사용했고 간단하게 박스와 버튼만 디자인 했습니다.
...
* 영화 정보
  ...
  ![image-20211125165817078](README.assets/image-20211125165817078.png)
  ...
  * 나름의 반응형을 지원합니다.
  * 그리고 이미 찜한영화는 출력되는 목록에서 제외되게 구현했습니다.
  ...
  ![image-20211125165841667](README.assets/image-20211125165841667.png)
  ...
  - 해당 찜목록은 프로필 페이지에서 확인 할 수 있습니다!
    ...
    ![image-20211125165859184](README.assets/image-20211125165859184.png)
...
![image-20211125165910210](README.assets/image-20211125165910210.png)

![image-20211125165918831](README.assets/image-20211125165918831.png)
...
![image-20211125165939029](README.assets/image-20211125165939029.png)

- 아까워서 넣은 보너스 기능 느낌입니다. 딱1개만 뜨게, 오직... 랜덤으로 나오게 구성했습니다.

  ![image-20211125165949928](README.assets/image-20211125165949928.png)
...
![image-20211125170001132](README.assets/image-20211125170001132.png)
...
![image-20211125170014501](README.assets/image-20211125170014501.png)

---

![image-20211125170033134](README.assets/image-20211125170033134.png)
...
![image-20211125170042543](README.assets/image-20211125170042543.png)

- 검은콩만의 특별한 추천 기능입니다.

  처음페이지에서 찜한 영화 목록기준으로 4가지의 영화를 랜덤으로 추천합니다.

  찜한영화가없으면 그냥 랜덤으로 추천합니다!

---

### 7. 프로필페이지

![image-20211125170053595](README.assets/image-20211125170053595.png)
...
![image-20211125170134715](README.assets/image-20211125170134715.png)
...
![image-20211125170149864](README.assets/image-20211125170149864.png)

- 네브바를 이용해 구현했고, 폰트어썸을 이용해 아이콘을 넣었습니다. 또한 오른쪽 프로필 페이지도
- 마우스커서만 올리면 목록이 나오게 만들었습니다!

![image-20211125170211258](README.assets/image-20211125170211258.png)



- 클릭만하면 언제라도 위로 올라갈 수 있게...
...
- 내부 db사용하기 - 100개 데이터 tmdb에서 가져와사용
- 관리자뷰 - Django기본 admin페이지사용
- 추천 알고리즘 - 랜덤추천,장르추천,그리고 찜한목록기반 검은콩만의 추천 알고리즘 구현
- 그외 요구사항 모두 충족

## 5) 배포 서버 URL

http://35.77.9.125:8000/

수업중에 진행한 AWS서버사용

![image-20211125104004441](README.assets/image-20211125104004441.png)
...
팀원과의 합... 매우 중요하다는걸 느꼈습니다. 다른조의 사정은 정확히 모르겠지만 적어도 저희조는 트러블도 문제도없이 잘 도맡아 마무리한것 같습니다. 결과물을 보니까 뿌듯하네여..!
...
처음에 배포 서버가 너무느려서 확인해보니..휴우... 미국 오하이오 주로 되어있었습니다. 너무 슬펐어요 그리고

서울서버로 만드려고했더니 죽어도 안만들어 지더군요... 그래서 대안으로 도쿄서버를 이용했습니다.

훨씬 빨라지긴 했지만 그래도 마음에 들진 않았어요! 이미지 파일 로딩이 너무 오래 걸렸습니다.

이미지 리사이징이라고 해야하나요? 일부 리사이징하고 TMDB자체에서 제공하는 이미지 리사이징을 이용했더니

마치 한국에서 이용하는 평범한 서버처럼 속도가 빨라졌습니다.
